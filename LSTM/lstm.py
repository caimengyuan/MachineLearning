...
class LstmLayer(object):
    def __init__(self, input_width, state_width, learning_rate):
        ...
        # 各个时刻的遗忘门f
        self.f_list = self.init_state_vac()
        # 各个时刻的输入门i
    ...
    def calc_delta(self, delta_h, activator):
        ...
        # 输出门误差项
        self.delte_o_list = self.init_dalta()
        # 输入门误差项
    ...
    def calc_delta_k(self, k):
        '''
        根据k时刻的delta_h, 计算k时刻的delta_f、delta_i、delta_0、delta_ct，以及k-1时刻的delta_h
        '''
        # 获得k时刻前向计算的值
        ig = self.i_list[k]
        og = self.o_list[k]
    ...
    def calc_gradient_t(self, t):
        ...
        Woh_grad = np.dot(self.delte_o_list[t], h_prev)
