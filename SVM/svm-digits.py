...
def testDigits(kTup=('rbf', 10)):
    ...
    Returns:
        无
    """
    dataArr,labelArr = loadImages('/Users/user/Desktop/Machine-Learning-master/kNN/3.数字识别/trainingDigits')
    ...
    dataArr,labelArr = loadImages('/Users/user/Desktop/Machine-Learning-master/kNN/3.数字识别/testDigits')
    errorCount = 0
    datMat = np.mat(dataArr); labelMat = np.mat(labelArr).transpose()
    m,n = np.shape(datMat)
    for i in range(m):
